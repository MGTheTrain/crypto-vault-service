...
// 				"PORT": "8080",
// 			},
// 			configFile: "test_config.yaml", // You need to create a sample YAML file
// 			expectedConfig: &GrpcConfig{
// 				Port:        "8080",
// 				GatewayPort: "8081", // Assuming it's set in the config file
// 				Database: DatabaseSettings{
// 					Type: "mysql",
// 					DSN:  "mysql://user:password@localhost/dbname",
// 					Name: "testdb",
// 				},
// 				// Set other config values accordingly
// 			},
// 		},
// 		{
...
// 		},
// 		{
// 			name: "missing required env variables",
// 			envVars: map[string]string{
// 				"PORT": "8080",
// 			},
// 			expectedError: true,
